...
ActiveRecord::Schema.define(version: 2020_07_09_231648) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["favoriter_id", "artwork_id"], name: "index_favorites_on_favoriter_id_and_artwork_id", unique: true
  end
